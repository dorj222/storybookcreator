...
def generate_description_story_gemma(user_input: str, chapter_index) -> str:
    device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')
    model = AutoModelForCausalLM.from_pretrained("google/gemma-2b-it", torch_dtype="auto", trust_remote_code=True)
